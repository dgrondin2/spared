Spared::Application.routes.draw do
  ...
  match '/login'       => 'sessions#donorlogin'
  match '/orglogin'    => 'sessions#orglogin'
  
  match '/donateitems' => 'sessions#donateitems'
  match '/donatetime'  => 'sessions#donatetime'
  match '/donatemoney' => 'sessions#donatemoney'
